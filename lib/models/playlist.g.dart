...
int _playlistEstimateSize(
  ...
  bytesCount += 3 + object.itemOrder.length * 8;
...
void _playlistSerialize(
  ...
  writer.writeLongList(offsets[1], object.itemOrder);
...
Playlist _playlistDeserialize(
  ...
  object.id = id;
  object.itemOrder = reader.readLongList(offsets[1]) ?? [];
...
void _playlistAttach(IsarCollection<dynamic> col, Id id, Playlist object) {
  object.id = id;
  object.items.attach(col, col.isar.collection<DownloadItem>(), r'items', id);
}
...
extension PlaylistQueryFilter
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition>
      itemOrderElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> itemOrderIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'itemOrder',
        0,
...
extension PlaylistQueryLinks
    on QueryBuilder<Playlist, Playlist, QFilterCondition> {
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> items(
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> itemsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> itemsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> itemsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlaylistQueryWhereDistinct
  ...
  QueryBuilder<Playlist, Playlist, QDistinct> distinctByItemOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistQueryProperty
  ...
  QueryBuilder<Playlist, List<int>, QQueryOperations> itemOrderProperty() {
    return QueryBuilder.apply(this, (query) {
